...
```
sudo bash -c "$(wget -qO- https://raw.githubusercontent.com/Al-Bsharat/tunnelbroker-proxies/main/main.sh)"
```
...
3. Install the script on your server with [one simple command](https://github.com/Al-Bsharat/tunnelbroker-proxies/blob/main/README.md#installation)
